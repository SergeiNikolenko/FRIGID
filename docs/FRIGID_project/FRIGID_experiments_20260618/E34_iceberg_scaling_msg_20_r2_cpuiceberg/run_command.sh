...
PY
  python scripts/spec2mol_scaling.py \
    ...
    --output-dir repro_runs/20260622T_iceberg_scaling_msg_20_r2_cpuiceberg/results \
    --split test \
    --max-spectra 20 \
    ...
    --iceberg-cpu \
    --iceberg-results-dir repro_runs/20260622T_iceberg_scaling_msg_20_r2_cpuiceberg/iceberg_results \
    --batch-size 32 \
...
} 2>&1 | tee repro_runs/20260622T_iceberg_scaling_msg_20_r2_cpuiceberg/run.log
