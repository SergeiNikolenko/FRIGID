...
source .venv/bin/activate
{
  ...
  python scripts/spec2mol_scaling.py \
    ...
    --output-dir repro_runs/20260622T_iceberg_scaling_msg_20_r1/results \
    --split test \
    --max-spectra 20 \
    ...
    --iceberg-gpu 0 \
    --iceberg-results-dir repro_runs/20260622T_iceberg_scaling_msg_20_r1/iceberg_results \
    --batch-size 32 \
...
} 2>&1 | tee repro_runs/20260622T_iceberg_scaling_msg_20_r1/run.log
