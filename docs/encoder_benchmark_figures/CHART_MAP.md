...
| `prospective_encoder_ranking.png` | Did any reproduced candidate beat the locked MIST baseline? | Sorted horizontal bars with promotion reference | model, mean fingerprint Tanimoto, paired delta, status | No candidate passed; JESTR is additionally not promotion-safe under the strongest official pretraining proxy | Blue baseline, gold quality fail, red overlap-evidence fail | Final joint benchmark, 15,325 evaluation rows, `benchmark_summary.json` SHA-256 `2b2c089f7c7d66b8f267c2a5ed00e16288bc42a17766478190f74e4ce5fa78c9` |
